                ...
                <table id="lists" class="table table-hover table-bordered">
                            ...
                            <td>
                                <div class="btn-group">
                                    <if condition="!$vo['is_dir']">
                                        <a href="javascript:;" onclick="formSubmit.del(this)" d-id="{$vo['fileurl']}" d-url="{:U('Admin/Tool/uploadfile', array('act'=>'del'))}" class="btn btn-default btn-xs"><i class="fa fa-trash-o"></i></a>
                                    </if>
                                </div>
                            </td>
                        </tr>
                    ...
                    <tr>
                        <th colspan="6" style="text-align: left;">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default btn-sm" d-url="{:U('Admin/Tool/uploadfile', array('act'=>'del'))}"
